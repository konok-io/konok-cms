...
<div class="row">
    <div class="col-lg-4">
        <div class="admin-card mb-4">
            <div class="card-header-custom">Add New Industry</div>
            <div class="card-body-custom">
                <form action="{{ route('admin.industries.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="icon" class="form-control" placeholder="e.g. fas fa-hospital">
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary w-100">Add Industry</button>
                </form>
            </div>
        </div>
    </div>
                ...
                <table class="table table-admin">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $industry->name }}</td>
                            <td><i class="{{ $industry->icon ?? 'fas fa-industry' }}"></i></td>
                            <td>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center text-muted py-4">No industries yet.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
